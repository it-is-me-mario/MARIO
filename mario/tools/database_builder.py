    ...
    def read_template(self,io):
        ...
        for level in self.levels:
            ...
            if level in self.unit_levels:
                ...
                if df.unit.isna().any():
                    raise WrongInput(f"pssoible issues with NaN Values found for level {level}. Each item for this level should have a unit of measure identified for.")
