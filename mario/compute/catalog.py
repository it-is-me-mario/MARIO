...
COMPUTE_CATALOG = {
    ...
    SUT: {
        ...
        "bu": _spec(
            ...
            SUT_COMMODITY_AXIS,
            SUT_ACTIVITY_AXIS,
            _extract("b", "extract_bu_from_b", "Extracted from unified b, only if available"),
            _formula(("Xc", "U"), "build_sut_bu_from_Xc_U", "bu = minverse(diag(Xc)) @ U"),
        ),
        "bs": _spec(
            SUT,
            "bs",
            ...
            SUT_ACTIVITY_AXIS,
            SUT_COMMODITY_AXIS,
            _extract("b", "extract_bs_from_b", "Extracted from unified b, only if available"),
            _formula(("Xa", "S"), "build_sut_bs_from_Xa_S", "bs = minverse(diag(Xa)) @ S"),
        ),
        "gcc": _spec(
            SUT,
            "gcc",
            ...
            SUT_COMMODITY_AXIS,
            SUT_COMMODITY_AXIS,
            _extract("g", "extract_gcc_from_g", "Extracted from unified g, only if available"),
            _formula(("bu", "bs"), "build_sut_gcc_from_bu_bs", "gcc = minverse(identity - bu @ bs)"),
        ),
        "gca": _spec(
            SUT,
            "gca",
            ...
            SUT_COMMODITY_AXIS,
            SUT_ACTIVITY_AXIS,
            _extract("g", "extract_gca_from_g", "Extracted from unified g, only if available"),
            _formula(("gcc", "bu"), "build_sut_gca_from_gcc_bu", "gca = gcc @ bu"),
        ),
        "gaa": _spec(
            SUT,
            "gaa",
            ...
            SUT_ACTIVITY_AXIS,
            SUT_ACTIVITY_AXIS,
            _extract("g", "extract_gaa_from_g", "Extracted from unified g, only if available"),
            _formula(("bs", "bu"), "build_sut_gaa_from_bs_bu", "gaa = minverse(identity - bs @ bu)"),
        ),
        "gac": _spec(
            SUT,
            "gac",
            ...
            SUT_ACTIVITY_AXIS,
            SUT_COMMODITY_AXIS,
            _extract("g", "extract_gac_from_g", "Extracted from unified g, only if available"),
            _formula(("gaa", "bs"), "build_sut_gac_from_gaa_bs", "gac = gaa @ bs"),
        ),
        "p": _spec(
            SUT,
            "p",
