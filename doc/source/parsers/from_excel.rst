...
* :doc:`mario.write_parse_template(...) <../api_document/mario.write_parse_template>`
* :doc:`mario.parse_from_excel(...) <../api_document/mario.parse_from_excel>`
* :doc:`mario.write_template_definition(...) <../api_document/mario.write_template_definition>`
...
For a new custom database, the recommended path is:

* define your sets and units;
* or define them in an Excel workbook generated by
  :doc:`mario.write_template_definition(...) <../api_document/mario.write_template_definition>`;
...
* :doc:`/workflows/provide_your_database`
...
When the workbook was generated by
:doc:`mario.write_parse_template(...) <../api_document/mario.write_parse_template>`,
the explicit flat layout is detected automatically.
...
* ``DataTemplate`` is deprecated; use ``write_parse_template(...)`` instead;
