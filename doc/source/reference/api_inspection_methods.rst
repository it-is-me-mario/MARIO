...
These methods help inspect a parsed database, retrieve matrices, inspect
available sets, and read metadata or scenario information.

Query and Block Access
----------------------
...
.. toctree::
   ...
   ../api_document/mario.CoreModel.GDP
   ../api_document/mario.CoreModel.is_balanced
   ../api_document/mario.CoreModel.is_hybrid
   ../api_document/mario.CoreModel.is_multi_region
   ../api_document/mario.CoreModel.is_chenerymoses
   ../api_document/mario.CoreModel.is_isard
